...
var quizJSON = {
    "info": {
        ...
        "level5":  "Return to the Map to study some more, and then you're on your way to becoming a Master of the Missions!"
    },
    "questions": [
        {
        ...
        { 
            ...
            "a": [
                ...
                {"option": "A place where people learn how to go undercover on a mission.", "correct": false} 
            ],
            "select_any": true,
            "correct": "<p><span>Correct!</span> A mission is a religious settlement where people come to worship.</p>",
            "incorrect": "<p><span>Incorrect.</span> A mission is actually a religious settlement where people come to worship.</p>" 
        },
        {
        ...
        },
        {
            ...
            "incorrect": "<p><span>Incorrect.</span>  Mission San Diego de Alcala is actually the southernmost mission.</p>" 
        },
        { 
            "q": "Was Mission San Francisco Solano founded last?",
            "a": [
                {"option": "Yes",    "correct": true},
                {"option": "No",     "correct": false} 
            ],
            "correct": "<p><span> Correct!</span> Mission San Francisco Solano was founded last.</p>",
            "incorrect": "<p><span>Incorrect.</span> Mission San Francisco Solano actually was founded last.</p>" 
        } 
    ]
};
